...
train_data.to_csv('resnet152_train_data.csv', index=False)
val_data.to_csv('resnet152_val_data.csv', index=False)
test_data.to_csv('resnet152_test_data.csv', index=False)

# Create dataset objects
train_dataset = ChestXrayDataset(csv_file='resnet152_train_data.csv', image_folder=image_folder, transform=train_transform)
val_dataset = ChestXrayDataset(csv_file='resnet152_val_data.csv', image_folder=image_folder, transform=test_transform)
test_dataset = ChestXrayDataset(csv_file='resnet152_test_data.csv', image_folder=image_folder, transform=test_transform)
