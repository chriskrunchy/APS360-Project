...
train_data.to_csv('csv/resnet152_train_data.csv', index=False)
val_data.to_csv('csv/resnet152_val_data.csv', index=False)
test_data.to_csv('csv/resnet152_test_data.csv', index=False)

# Create dataset objects
train_dataset = ChestXrayDataset(csv_file='csv/resnet152_train_data.csv', image_folder=image_folder, transform=train_transform)
val_dataset = ChestXrayDataset(csv_file='csv/resnet152_val_data.csv', image_folder=image_folder, transform=test_transform)
test_dataset = ChestXrayDataset(csv_file='csv/resnet152_test_data.csv', image_folder=image_folder, transform=test_transform)
...
model_save_path = 'resnet152_model.pth'
...
plt.savefig('resnet152_loss_curve.pdf')
...
plt.savefig('resnet152_accuracy_curve.pdf')
...
plt.title('ResNet152 Confusion Matrix', fontsize=16)
plt.xlabel('Predicted Label', fontsize=14)
plt.ylabel('True Label', fontsize=14)
plt.xticks(rotation=45, fontsize=12)
plt.yticks(rotation=0, fontsize=12)
plt.savefig('resnet152_confusion_matrix.pdf')
...
plt.title('ResNet152 Receiver Operating Characteristic')
plt.legend(loc='lower right')
plt.savefig('resnet152_roc_curve.pdf')
