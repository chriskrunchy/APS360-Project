...
train_data.to_csv('resnet50_train_data.csv', index=False)
val_data.to_csv('resnet50_val_data.csv', index=False)
test_data.to_csv('resnet50_test_data.csv', index=False)

# Create dataset objects
train_dataset = ChestXrayDataset(csv_file='resnet50_train_data.csv', image_folder=image_folder, transform=train_transform)
val_dataset = ChestXrayDataset(csv_file='resnet50_val_data.csv', image_folder=image_folder, transform=test_transform)
test_dataset = ChestXrayDataset(csv_file='resnet50_test_data.csv', image_folder=image_folder, transform=test_transform)
