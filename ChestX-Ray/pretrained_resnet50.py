...
train_data.to_csv('csv/resnet50_train_data.csv', index=False)
val_data.to_csv('csv/resnet50_val_data.csv', index=False)
test_data.to_csv('csv/resnet50_test_data.csv', index=False)

# Create dataset objects
train_dataset = ChestXrayDataset(csv_file='csv/resnet50_train_data.csv', image_folder=image_folder, transform=train_transform)
val_dataset = ChestXrayDataset(csv_file='csv/resnet50_val_data.csv', image_folder=image_folder, transform=test_transform)
test_dataset = ChestXrayDataset(csv_file='csv/resnet50_test_data.csv', image_folder=image_folder, transform=test_transform)
...
plt.savefig('resnet50_loss_curve.pdf')
...
plt.savefig('resnet50_accuracy_curve.pdf')
...
plt.title('ResNet50 Receiver Operating Characteristic')
plt.legend(loc='lower right')
plt.savefig('resnet50_roc_curve.pdf')
